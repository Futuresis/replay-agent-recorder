# Original README details archive

> This file preserves lower-level notes from an earlier top-level `README.md`. Some paths were updated during the documentation refresh. For the current public documentation map, start with `README.md` and `docs/README.md`.
...
- `docs/architecture/`: visualization implementation notes and internal contracts.
...
[`integration-scaffold.md`](integration-scaffold.md) for the full
...
[`tool-adapter-protocol.md`](tool-adapter-protocol.md).
...
diff highlighting. See `docs/visualization.md` for the full
...
- `docs/architecture/`: 可视化实现说明和内部契约。
...
Agent1/Agent2/Agent3 were earlier placeholder demos and are no longer part of the maintained public quickstart. The maintained deterministic demo is Agent4.
